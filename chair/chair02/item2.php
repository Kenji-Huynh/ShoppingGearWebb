<?php
// filepath: d:\ShoppingGearWebb\chair\chair02\item2.php
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Ghế WGC203 | GameChair Pro</title>
  ...
  <body>
    ...
    <div class="container main-content-wrapper">
      ...
      <section class="item-container">
        ...
        <div class="item-info">
          <h1 class="item-name">Ghế WGC203</h1>
          <div class="item-rating">
            <span class="item-rate">4.5</span>
        ...
        <div class="item-detail-container">
          <div class="detail-text-container">
            ...
            <div class="detail-text">
              <p>Ghế gaming WGC203 với thiết kế cao cấp dành cho game thủ chuyên nghiệp:</p>
              <ul>
                <li>Chất liệu da PU cao cấp, dễ dàng vệ sinh</li>
                <li>Tựa lưng thiết kế theo đường cong cột sống</li>
                <li>Tay vịn 4D điều chỉnh được độ cao, góc nghiêng</li>
                <li>Có thể ngả lưng 155 độ</li>
                <li>Khung thép chắc chắn, chịu lực tốt</li>
                <li>Gối đầu và gối thắt lưng cao su non</li>
                <li>Bánh xe cao su di chuyển êm ái trên mọi bề mặt</li>
              </ul>
            </div>
          </div>
        </div>
