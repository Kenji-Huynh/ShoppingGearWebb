<?php
// filepath: d:\ShoppingGearWebb\chair\chair01\item1.php
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Ghế WGC225 | GameChair Pro</title>
  ...
  <body>
    ...
    <div class="container main-content-wrapper">
      ...
      <section class="item-container">
        ...
        <div class="item-info">
          <h1 class="item-name">Ghế WGC225</h1>
          <div class="item-rating">
            <span class="item-rate">4.8</span>
            <i class="item-icon fa-solid fa-star"></i>
          </div>
          <div class="item-price-container">
            <p class="item-price">1.000.000 VND <span class="item-price-dis">1.290.000 VND</span></p>
        ...
        <div class="item-detail-container">
          <div class="detail-text-container">
            ...
            <div class="detail-text">
              <p>Ghế gaming WGC225 được thiết kế tối ưu cho các game thủ với các tính năng:</p>
              <ul>
                <li>Chất liệu da PU cao cấp, dễ dàng vệ sinh, chống bám bụi</li>
                <li>Tựa lưng ergonomic giúp nâng đỡ cột sống</li>
                <li>Tay vịn 4D điều chỉnh được độ cao, góc nghiêng</li>
                <li>Có thể ngả lưng 180 độ</li>
                <li>Khung kim loại chắc chắn, chịu lực tốt</li>
                <li>Gối đầu và gối thắt lưng tiện lợi</li>
                <li>Bánh xe cao su di chuyển êm ái</li>
              </ul>
            </div>
          </div>
        </div>
