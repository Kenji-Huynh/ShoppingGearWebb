<?php
// filepath: d:\ShoppingGearWebb\keyboard\keyboard01\01.php
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Bàn phím cơ Aula F75 | GameChair Pro</title>
  ...
  <body>
    ...
    <div class="container main-content-wrapper">
      ...
      <section class="item-container">
        ...
        <div class="item-info">
          <h1 class="item-name">Bàn phím cơ Aula F75</h1>
          ...
          <div class="item-actions">
            <button class="item-btn" onclick="addToCart({
              ...
              price: 1000000,
              category: 'Keyboard',
              image: '/ShoppingGearWebb/keyboard/img/key01.jpg'
            })">
        ...
        <div class="item-detail-container">
          <div class="detail-text-container">
            ...
            <div class="detail-text">
              <p>Bàn phím cơ Aula F75 với thiết kế tối ưu cho game thủ:</p>
              <ul>
                <li>Switch cơ học Blue độ bền 50 triệu lần nhấn</li>
                <li>Backlit RGB 16.8 triệu màu</li>
                <li>Thiết kế TKL nhỏ gọn, tiết kiệm không gian</li>
                <li>Keycap ABS Double Shot bền bỉ</li>
                <li>Chức năng Anti-ghosting</li>
                <li>Có thể tuỳ chỉnh nhiều hiệu ứng ánh sáng</li>
                <li>Dây bọc dù chống đứt, độ bền cao</li>
              </ul>
            </div>
          </div>
        </div>
