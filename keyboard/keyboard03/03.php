<?php
// filepath: d:\ShoppingGearWebb\keyboard\keyboard03\03.php
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Bàn phím cơ Astronaut | GameChair Pro</title>
        ...
        <div class="item-info">
          ...
          <div class="item-actions">
            <button class="item-btn" onclick="addToCart({
              ...
              price: 1000000,
              category: 'Keyboard',
              image: '/ShoppingGearWebb/keyboard/img/key03.jpg'
            })">
        ...
        <div class="item-detail-container">
          <div class="detail-text-container">
            ...
            <div class="detail-text">
              <p>Bàn phím cơ Astronaut với thiết kế độc đáo theo chủ đề không gian:</p>
              <ul>
                <li>Switch cơ học cao cấp Brown, cảm giác gõ êm ái</li>
                <li>Hiệu ứng LED RGB theo chủ đề vũ trụ</li>
                <li>Keycap XDA profile tùy chỉnh với hình ảnh phi hành gia</li>
                <li>Kết nối USB Type-C có thể tháo rời</li>
                <li>Hỗ trợ NKRO và Anti-ghosting</li>
                <li>Khung kim loại chắc chắn, độ bền cao</li>
                <li>Phần mềm tùy chỉnh macro đa dạng</li>
              </ul>
            </div>
          </div>
        </div>
